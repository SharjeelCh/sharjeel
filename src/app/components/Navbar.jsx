...
const Navbar = () => {
  ...
  return (
    <>
      <motion.div
        style={{ scaleX }}
        className="fixed top-0 left-0 right-0 h-[3px] bg-gradient-to-r from-blue-600 to-purple-700 z-50 origin-left"
      />
      ...
      <motion.nav
        ...
        className={`fixed w-full z-40 transition-all duration-300 ${
          isScrolled 
            ? 'py-4 bg-white/10 dark:bg-gray-900/10 backdrop-blur-md shadow-lg' 
            : 'py-6 bg-white/5 dark:bg-gray-900/5 backdrop-blur-sm'
        }`}
      >
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        <motion.div
                          className="absolute inset-0 rounded-full bg-gradient-to-r from-blue-500/20 to-purple-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-200"
                          initial={false}
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            ...
            >
              <div className="px-2 pt-2 pb-3 space-y-1 bg-white/10 dark:bg-gray-900/10 backdrop-blur-md mt-2 rounded-lg mx-4">
                {navItems.map((item, index) => {
                  const Icon = item.icon;
                  const isActive = activeSection === item.href.substring(1);
