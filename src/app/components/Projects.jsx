...
const Projects = ({ projects: projectsProp }) => {
  ...
  const cardWidth = windowWidth < 640 ? 410 : 800;
  const cardGap = windowWidth < 640 ? 15 : 30;

  const isFiltered = !!projectsProp;
  const displayProjects = isFiltered ? projectsProp : projects[activeCategory];
  const numCards = displayProjects.length;
