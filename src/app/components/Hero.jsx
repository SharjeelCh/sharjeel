        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <motion.div
              ...
              className="space-y-4"
            >
              <h2 className="text-lg font-medium text-blue-400 code-block inline-block">Hello, I'm</h2>
              <h1 className="text-4xl sm:text-6xl font-bold text-white">
                Creative Developer
              </h1>
              <p className="text-xl text-gray-300 max-w-lg code-block">
                Crafting unique digital experiences through elegant code and creative design
              </p>
            </motion.div>
            ...
            >
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="px-8 py-3 bg-white text-black rounded-lg font-medium  transition-colors duration-200"
              >
                View Projects
              </motion.a>
              <motion.a
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="px-8 py-3 border border-gray-600 text-white rounded-lg font-medium hover:border-gray-400 transition-colors duration-200"
              >
                Hire Me
              </motion.a>
            </motion.div>
